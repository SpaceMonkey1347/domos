    ...
    1)
        ...
        case "$scope_opt" in
            ...
            2)
                ...
                sudo mkdir -p $CHROME_LOCAL_DIR && sudo cp $SCRIPT_DIR/com.example.uinput.json $CHROME_LOCAL_DIR
                ;;
            *)
    ...
    2)
        ...
        case "$scope_opt" in
            ...
            2)
                ...
                sudo mkdir -p $FIREFOX_LOCAL_DIR && sudo cp $SCRIPT_DIR/uinput.json $FIREFOX_LOCAL_DIR
                ;;
            *)
                echo "Invalid manifest directory choice. Exiting."
                exit 1
